      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="w-full">
          ...
          <input
            ...
            required
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-gray-300 focus:ring-1 focus:ring-gray-500 focus:outline-none"
        ...
        <div className="flex justify-end gap-4">
          <button
            type="button"
            onClick={() => router.back()}
            className="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none"
          >
            취소
          </button>
          <button
