        ...
        {isGetMcps && mcpTools ? (
          ...
          new Array(3)
            ...
            .map((_, i) => (
              <div
                key={i}
                className="h-8 w-24 animate-pulse rounded-full bg-gray-200 dark:bg-zinc-600"
              />
            ))
        )}
      </div>
      {/* tools parameter */}
      <div className="rounded-lg bg-gray-50 p-4 md:col-span-2 dark:bg-zinc-700">
        <div className="mb-2 flex justify-between">
          ...
          {Object.keys(editedParam).length > 0 && (
            <button
              ...
              className="cursor-pointer rounded bg-gray-600 px-4 py-1 text-sm text-white hover:bg-gray-800 dark:bg-zinc-700 dark:hover:bg-zinc-600"
            >
              변경사항 저장
            </button>
          )}
        ...
        {/* grid header */}
        <div className="grid grid-cols-8 items-center justify-center gap-1 border-b border-gray-300 bg-gray-300 p-2 text-sm lg:grid-cols-12 dark:border-zinc-600 dark:bg-zinc-600">
          <div className="row-span-2 text-center text-gray-900 lg:row-span-1 dark:text-zinc-100">
            No.
          </div>
          <div className="col-span-7 text-gray-900 lg:col-span-4 dark:text-zinc-100">
            Value
          </div>
          <div className="col-span-5 text-gray-900 dark:text-zinc-100">
            설명
          </div>
          <div className="col-span-2 text-center text-gray-900 dark:text-zinc-100">
            작업
          </div>
        </div>
        <div className="grid grid-cols-8 items-center justify-center divide-y divide-gray-200 text-sm lg:grid-cols-12 dark:divide-zinc-600">
          {paramPending || !paramSuccess ? (
            <div className="col-span-8 grid grid-cols-8 items-center gap-1 p-2 lg:col-span-12 lg:grid-cols-12">
              <div className="row-span-2 h-5 w-8 animate-pulse rounded-md bg-gray-300 lg:row-span-1 dark:bg-zinc-600" />
              <div className="col-span-7 h-5 w-72 animate-pulse rounded-md bg-gray-300 lg:col-span-4 dark:bg-zinc-600" />
              <div className="col-span-5 h-5 w-56 animate-pulse rounded-md bg-gray-300 dark:bg-zinc-600" />
              <div className="col-span-2 h-5 w-16 animate-pulse rounded-md bg-gray-300 dark:bg-zinc-600" />
            </div>
          ) : (
            toolParams &&
            toolParams.map((item) => (
              ...
              >
                <div className="text-cente row-span-2 text-center text-gray-900 lg:row-span-1 dark:text-zinc-100">
                  {editedParam[item.ORDER_NO] ? (
                    <input
                      type="number"
                      value={editedParam[item.ORDER_NO]?.ORDER_NO || ''}
                      readOnly
                      className="w-full rounded border border-gray-300 bg-gray-100 px-1 text-gray-900 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100"
                      min="1"
                    />
                  ) : (
                    item.ORDER_NO
                ...
                <div className="col-span-7 font-bold text-gray-900 lg:col-span-4 dark:text-zinc-100">
                  {editedParam[item.ORDER_NO] ? (
                    <input
                      type="text"
                      ...
                      className="w-full rounded border border-gray-300 bg-white px-1 text-gray-900 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100"
                    />
                  ) : (
                    item.ARGUMENT
                  )}
                </div>
                <div className="col-span-5 text-gray-700 italic dark:text-zinc-300">
                  {editedParam[item.ORDER_NO] ? (
                    <input
                      type="text"
                  ...
                  {editedParam[item.ORDER_NO] ? (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="w-full cursor-pointer rounded bg-red-200 px-2 py-1 hover:bg-red-300 dark:bg-red-900 dark:text-red-200 dark:hover:bg-red-800"
                      >
                        삭제
                      </button>
                      <button
                        onClick={() => handleCancel(item.ORDER_NO)}
                        className="w-full cursor-pointer rounded bg-gray-300 px-2 py-1 hover:bg-gray-400 dark:bg-zinc-600 dark:text-zinc-100 dark:hover:bg-zinc-500"
                      >
                        취소
                      </button>
                    </div>
          ...
          {/* add parameter */}
          {isAddingNew ? (
            <div className="col-span-8 grid grid-cols-8 items-center justify-center gap-2 bg-amber-50 px-2 py-4 lg:col-span-12 lg:grid-cols-12 dark:bg-amber-900/20">
              <div className="row-span-2 text-center text-gray-900 lg:row-span-1 dark:text-zinc-100">
                New
              </div>
              ...
              <div className="col-span-2">
                <div className="flex gap-2">
                  <button
                    ...
                    className="w-full cursor-pointer rounded bg-gray-500 px-2 py-1 text-white hover:bg-gray-600 dark:bg-zinc-600 dark:hover:bg-zinc-700"
                  >
                    저장
                  </button>
                  <button
            ...
            <div className="col-span-8 grid grid-cols-8 items-center justify-center gap-2 px-2 py-4 lg:col-span-12 lg:grid-cols-12">
